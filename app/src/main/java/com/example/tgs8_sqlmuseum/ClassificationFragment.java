...
public class ClassificationFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.activity_classification_fragment,null);
        recyclerViewclass=v.findViewById(R.id.recyclerobj);
        modelClassArrayList = new ArrayList<>();
        recyclerViewclass.setLayoutManager(new LinearLayoutManager(getContext()));
